...
public class Lt extends AbstractBooleanCalculation {
	private static final long serialVersionUID = -2868369121377355228L;
	...
	public Lt(Matrix m1, double v2) throws MatrixException {
		this(m1, MatrixFactory.fill(v2, m1.getSize()));
	}

	public Lt(double v1, Matrix m2) throws MatrixException {
