...
public class DefaultDenseDoubleMatrixFactory extends
		AbstractDenseDoubleMatrixFactory<DenseDoubleMatrix> implements
		DenseDoubleMatrixFactory<DenseDoubleMatrix> {
