...
public class DefaultDenseMatrixWriterLatexExporter extends AbstractDenseMatrixWriterExporter
		implements MatrixLatexExportFormat {

	public DefaultDenseMatrixWriterLatexExporter(DenseMatrix matrix, Writer writer) {
		super(matrix, writer);
	}
