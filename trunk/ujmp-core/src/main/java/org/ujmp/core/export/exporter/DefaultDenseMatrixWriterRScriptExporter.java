...
public class DefaultDenseMatrixWriterRScriptExporter extends AbstractDenseMatrixWriterExporter
		implements MatrixRScriptExportFormat {

	public DefaultDenseMatrixWriterRScriptExporter(DenseMatrix matrix, Writer writer) {
		super(matrix, writer);
	}
