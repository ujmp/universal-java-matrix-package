...
public class DefaultMatrixFileJPGImporter extends AbstractMatrixFileImporter implements
		MatrixJPGImportFormat {

	public DefaultMatrixFileJPGImporter(File file) {
		super(file);
	}

	public Matrix asJPG() throws IOException {
		return new ImageMatrix(getFile());
	}
