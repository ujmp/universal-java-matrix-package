...
public class ImportMatrixGRAPHML {
	...
	// key.attr_name = element.getAttributeByName(new
	// QName("attr.name")).getValue();
	// key.attr_type = element.getAttributeByName(new
	// QName("attr.type")).getValue();
	// currentEvent = eventReader.nextEvent();
	// skipCharacters();
	// if (currentEvent.getEventType() == XMLEvent.START_ELEMENT
	// &&
	...
	// skipCharacters();
	// if
	// (!"default".equals(currentEvent.asEndElement().getName().getLocalPart()))
	// {
	...
	// {
	// String key = currentEvent.asStartElement().getAttributeByName(new
	// QName("key"))
	// .getValue();
	// currentEvent = eventReader.nextEvent();
	...
	// StartElement element = currentEvent.asStartElement();
	// String id = element.getAttributeByName(new QName("id")).getValue();
	// String source = element.getAttributeByName(new
	// QName("source")).getValue();
	// String target = element.getAttributeByName(new
	...
	// if
	// ("graphml".equals(currentEvent.asStartElement().getName().getLocalPart()))
	// {
	//
	// currentEvent = eventReader.nextEvent();
	// skipCharacters();
	...
	// StartElement element = currentEvent.asStartElement();
	// String id = element.getAttributeByName(new QName("id")).getValue();
	// String edgedefault = element.getAttributeByName(new
	// QName("edgedefault")).getValue();
	//
	// currentEvent = eventReader.nextEvent();
	// skipCharacters();
	//
