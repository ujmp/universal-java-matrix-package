...
public class TestReplaceRegex {
	...
	private static Matrix getTestMatrix() {
		Matrix m = StringMatrix.Factory.zeros(2, 2);
	...
	public void testCalc1() {
		Matrix matrix = getTestMatrix();
		Matrix resultMatrix = new ReplaceRegex(matrix, "ab", "fgr").calcNew();
		Assert.assertEquals(getResultMatrix(), resultMatrix);
	}
	...
	public void testCalc2() {
		Matrix matrix = getTestMatrix();
		Matrix resultMatrix = new ReplaceRegex(matrix, Pattern.compile("ab"), "fgr").calcNew();
		Assert.assertEquals(getResultMatrix(), resultMatrix);
	}
