...
public class JDBCStringMap extends AbstractJDBCMap<String> {
	private static final long serialVersionUID = 4744307432617930795L;

	public static JDBCStringMap connectToMySQL(String serverName, int port, String databaseName, String tableName,
			String username, String password, String columnForKeys, String columnForValues) throws SQLException {
		return new JDBCStringMap("jdbc:mysql://" + serverName + ":" + port + "/" + databaseName
	...
	public static JDBCStringMap connectToHSQLDB() throws SQLException, IOException {
		return new JDBCStringMap("jdbc:hsqldb:file:/" + File.createTempFile("hsqldb", ".temp"), null, "SA", "", null,
				null);
	}

	public static JDBCStringMap connectToHSQLDB(File fileName) throws SQLException {
		return new JDBCStringMap("jdbc:hsqldb:file:/" + fileName.getAbsolutePath(), null, "SA", "", null, null);
	}

	public static JDBCStringMap connectToHSQLDB(File fileName, String tableName) throws SQLException {
		return new JDBCStringMap("jdbc:hsqldb:file:/" + fileName.getAbsolutePath(), tableName, "SA", "", null, null);
	}

	public static JDBCStringMap connectToHSQLDB(File fileName, String tableName, String userName, String password)
			throws SQLException {
		return new JDBCStringMap("jdbc:hsqldb:file:/" + fileName.getAbsolutePath(), tableName, userName, password,
				null, null);
	}

	public static JDBCStringMap connect(String url, String tableName, String userName, String password,
			String keyColumnName, String valueColumnName) throws SQLException {
		return new JDBCStringMap(url, tableName, userName, password, keyColumnName, valueColumnName);
	}

	public static JDBCStringMap connect(String url, String tableName, String userName, String password)
			throws SQLException {
		return new JDBCStringMap(url, tableName, userName, password, null, null);
	}

	private JDBCStringMap(String url, String tableName, String username, String password, String keyColumnName,
	...
	public synchronized String put(String key, String value) {
		...
		try {
			...
			if (oldValue == null) {
				...
				insertStatement.setString(2, String.valueOf(value));
