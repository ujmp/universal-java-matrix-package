...
package org.ujmp.jmatharray.benchmark;
...
public class JMathArrayDenseDoubleMatrix2DBenchmark extends
		AbstractMatrix2DBenchmark {

	public Matrix createMatrix(long... size) throws MatrixException {
		return new JMathArrayDenseDoubleMatrix2D(size);
	}
	...
	public static void main(String[] args) throws Exception {
		AbstractMatrix2DBenchmark benchmark = new JMathArrayDenseDoubleMatrix2DBenchmark();
