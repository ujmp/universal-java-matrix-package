...
public class JMathPlotLine3DPanel extends AbstractJMathPlotPanel {
	private static final long serialVersionUID = 4821955131872353981L;

	public JMathPlotLine3DPanel(Matrix matrix) {
		super(matrix);
	}
	...
	public void repaintUI() {
		...
		for (int c = 2; c < matrix.getColumnCount(); c++) {
			...
			panel.addLinePlot("Column " + c, x, y, z);
		}
