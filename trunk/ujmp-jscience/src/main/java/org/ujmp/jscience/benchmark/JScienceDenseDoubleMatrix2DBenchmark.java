...
package org.ujmp.jscience.benchmark;
...
public class JScienceDenseDoubleMatrix2DBenchmark extends AbstractMatrix2DBenchmark {
	...
	public static void main(String[] args) throws Exception {
		MatrixBenchmark benchmark = new JScienceDenseDoubleMatrix2DBenchmark();
		benchmark.run();
	}
