...
package org.ujmp.mantissa.benchmark;
...
public class MantissaDenseDoubleMatrix2DBenchmark extends AbstractMatrix2DBenchmark {

	public DoubleMatrix2D createMatrix(long... size) {
		return new MantissaDenseDoubleMatrix2D(MathUtil.longToInt(size[Matrix.ROW]),
	...
	public static void main(String[] args) throws Exception {
		MatrixBenchmark benchmark = new MantissaDenseDoubleMatrix2DBenchmark();
		benchmark.run();
	}
