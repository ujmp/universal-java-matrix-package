...
public interface MinusMatrix<T> {
	...
	public static final MinusMatrix<Matrix> INSTANCE = new MinusMatrix<Matrix>() {
	...
	public static final MinusMatrix<DenseMatrix> DENSEMATRIX = new MinusMatrix<DenseMatrix>() {
	...
	public static final MinusMatrix<SparseMatrix> SPARSEMATRIX = new MinusMatrix<SparseMatrix>() {
	...
	public static final MinusMatrix<DenseMatrix2D> DENSEMATRIX2D = new MinusMatrix<DenseMatrix2D>() {
	...
	public static final MinusMatrix<DenseDoubleMatrix2D> DENSEDOUBLEMATRIX2D = new MinusMatrix<DenseDoubleMatrix2D>() {
