...
public class Idf extends AbstractDoubleCalculation {
	private static final long serialVersionUID = -4461501034918481144L;
	...
	public double getDouble(long... coordinates) throws MatrixException {
		...
		double result = MathUtil.log10(numDocs / sumPerTerm.getAsDouble(0, coordinates[COLUMN]));
	...
	public long[] getSize() {
		...
		return new long[] { 1, docTerm.getColumnCount() };
	}
