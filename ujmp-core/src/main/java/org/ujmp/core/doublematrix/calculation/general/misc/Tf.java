...
public class Tf extends AbstractDoubleCalculation {
	private static final long serialVersionUID = -5500104984018082009L;
	...
	public Tf(Matrix matrix) {
		super(matrix);
	}

	@Override
	public double getDouble(long... coordinates) throws MatrixException {
		if (docTerm == null || sumPerDoc == null) {
			calculate();
		}
		double result = docTerm.getAsDouble(coordinates)
				/ sumPerDoc.getAsDouble(coordinates[ROW], 0);
