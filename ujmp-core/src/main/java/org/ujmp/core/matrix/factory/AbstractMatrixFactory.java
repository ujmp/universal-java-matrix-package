...
public abstract class AbstractMatrixFactory<T extends Matrix> implements BaseMatrixFactory<T> {
    ...
    public final Matrix range(double startInclusive, double endExclusive, double stepSize) {
        return Matrix.Factory.linkToArray(MathUtil.sequenceDouble(startInclusive, endExclusive, stepSize));
    }

    public final Matrix range(double startInclusive, double endExclusive) {
