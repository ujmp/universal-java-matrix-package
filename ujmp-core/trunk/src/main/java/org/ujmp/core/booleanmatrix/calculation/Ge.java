...
public class Ge extends AbstractBooleanCalculation {
	...
	public Ge(Matrix m1, double v2) throws MatrixException {
		this(m1, MatrixFactory.fill(v2, m1.getSize()));
	}

	public Ge(double v1, Matrix m2) throws MatrixException {
