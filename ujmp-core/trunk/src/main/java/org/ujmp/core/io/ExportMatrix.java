...
public abstract class ExportMatrix {
	...
	public static final void toFile(Format format, String filename, Matrix matrix, Object... parameters)
	...
	public static final String toString(Format format, Matrix matrix, Object... parameters) throws MatrixException,
			IOException {
	...
	public static final void toClipboard(Format format, Matrix matrix, Object... parameters) throws MatrixException,
			IOException {
	...
	public static final void toStream(Format format, OutputStream outputStream, Matrix matrix, Object... parameters)
			throws IOException {
		try {
			Class<?> c = Class.forName("org.ujmp.core.io.ExportMatrix" + format.name());
	...
	public static final void toWriter(Format format, Writer writer, Matrix matrix, Object... parameters) {
		try {
			Class<?> c = Class.forName("org.ujmp.core.io.ExportMatrix" + format.name());
