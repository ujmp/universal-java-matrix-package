...
package org.ujmp.ejml.benchmark;
...
public class EJMLDenseDoubleMatrix2DBenchmark extends AbstractMatrix2DBenchmark {
	...
	public static void main(String[] args) throws Exception {
		MatrixBenchmark benchmark = new EJMLDenseDoubleMatrix2DBenchmark();
		benchmark.run();
	}
