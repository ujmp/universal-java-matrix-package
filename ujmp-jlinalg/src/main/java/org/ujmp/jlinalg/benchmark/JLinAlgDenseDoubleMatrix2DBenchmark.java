...
package org.ujmp.jlinalg.benchmark;
...
public class JLinAlgDenseDoubleMatrix2DBenchmark extends AbstractMatrix2DBenchmark {

	public DoubleMatrix2D createMatrix(long... size) {
		return new JLinAlgDenseDoubleMatrix2D(MathUtil.longToInt(size[Matrix.ROW]),
