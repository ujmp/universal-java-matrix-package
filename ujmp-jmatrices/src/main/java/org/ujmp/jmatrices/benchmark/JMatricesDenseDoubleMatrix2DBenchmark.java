...
public class JMatricesDenseDoubleMatrix2DBenchmark extends AbstractMatrix2DBenchmark {

	public DoubleMatrix2D createMatrix(long... size) {
		return new JMatricesDenseDoubleMatrix2D(MathUtil.longToInt(size[Matrix.ROW]),
	...
	public static void main(String[] args) throws Exception {
		MatrixBenchmark benchmark = new JMatricesDenseDoubleMatrix2DBenchmark();
		benchmark.run();
	}
