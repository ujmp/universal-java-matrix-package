...
public class ParallelColtDenseDoubleMatrix2DBenchmark extends AbstractMatrix2DBenchmark {

	public DoubleMatrix2D createMatrix(long... size) {
		return new ParallelColtDenseDoubleMatrix2D(MathUtil.longToInt(size[Matrix.ROW]),
	...
	public static void main(String[] args) throws Exception {
		MatrixBenchmark benchmark = new ParallelColtDenseDoubleMatrix2DBenchmark();
		benchmark.run();
	}
